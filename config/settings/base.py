...
# surfgreen_app/
APPS_DIR = BASE_DIR / "surfgreen_app"
env = environ.Env()
...
MIGRATION_MODULES = {"sites": "surfgreen_app.contrib.sites.migrations"}
...
CSRF_TRUSTED_ORIGINS = ['https://surfgreen.dev', 'https://www.surfgreen.dev']
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "surfgreen_app.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/forms.html
ACCOUNT_FORMS = {"signup": "surfgreen_app.users.forms.UserSignupForm"}
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "surfgreen_app.users.adapters.SocialAccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/forms.html
SOCIALACCOUNT_FORMS = {"signup": "surfgreen_app.users.forms.UserSocialSignupForm"}
# django-compressor
# ------------------------------------------------------------------------------
...
SPECTACULAR_SETTINGS = {
    "TITLE": "surfgreen_app API",
    "DESCRIPTION": "Documentation of API endpoints of surfgreen_app",
    "VERSION": "1.0.0",
